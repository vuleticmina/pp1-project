...
public class DesignatorStatementChange extends DesignatorStatement {

    private Designator Designator;
    private Change Change;

    public DesignatorStatementChange (Designator Designator, Change Change) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementChange(\n");
